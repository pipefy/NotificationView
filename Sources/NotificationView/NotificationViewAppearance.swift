//
//  NotificationViewAppearance.swift
//  NotificationView
//
//
...
public class NotificationAppearance: NSObject {
    
    /// Default appearance
    public static let defaultAppearance = NotificationAppearance()
    ...
    func viewMarginTopPreDisplay(notiData: NotificationData?) -> CGFloat {
    ...
    /// Size
    func viewInitRect(notiData: NotificationData?) -> CGRect {
    ...
    func viewSizeHeigth(notiData: NotificationData?) -> CGFloat {
